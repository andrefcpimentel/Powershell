...
function HasTentacleMissedRelease{
    ...
    .EXAMPLE 
    HasTentacleMissedRelease -OfflineDropBase "\\deploymentlocation" -OfflineDropBatch "Offline_install_cmd.cmd" -JournalFile "c:\Octopus\DeploymentJournal.xml"
    #>
    param
    (
...
function LogToFile
{
    ...
    Add-Content -Path "c:\temp\HasTentacleMissedRelease.log" -Value "`n$logEntry"
}
...
else
{
    ...
    $OfflinePackageDropLocation = "\\drop_location"
    $OfflinePackageBatchFile = "cmd_to_execute.cmd"
    ...
    if ($RunBatchFile)
    {
        ...
        $label2a.Text = "Your PC is in the process of downloading the latest software."
        ...
        $label2b.Text = "Please wait until the process in completed"
        ...
        $label2d.Text = "When this message box closes, you can proceed and log into Flame. Thank you for your patience."
        ...
        $label2e.Text = "If you experience any issues during this process then please contact xxxxxx"
        ...
        Start-Process -FilePath $BatchFileToRun -RedirectStandardOutput "c:\temp\HasTentacleMissedRelease.out" -RedirectStandardError "c:\temp\HasTentacleMissedRelease.err" -Wait
    
        LogToFile -logEntry "Standard Output has been redirected to: c:\temp\HasTentacleMissedRelease.out"
        LogToFile -logEntry "STandard Error Output has been redirected to: c:\temp\HasTentacleMissedRelease.err"
        ...
        $label4.Text = "Application Update finish - You may continue your work."
